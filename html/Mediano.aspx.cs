...
{
    public partial class Mediano : System.Web.UI.Page
    {
       ...
       /* protected void BtnMediano_Click(object sender, EventArgs e)
        {
            ...
            int CantidadA = Convert.ToInt32(txtMedianoA.text);
            int CantidadB = Convert.ToInt32(txtMedianoB.Text);
            int CantidadC = Convert.ToInt32(txtMedianoA.Text);
            ...
            txtMediano.Text = $"Total: {totalE:C}";
        }*/
    }
}