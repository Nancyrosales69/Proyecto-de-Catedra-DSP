...
{
    public partial class Grande : System.Web.UI.Page
    {
       ...
       /* protected void BtnGrande_Click(object sender, EventArgs e)
        {
            ...
            int CantidadA = Convert.ToInt32(txtGrandeA.Text);
            int CantidadB = Convert.ToInt32(txtGrandeB.Text);
            int CantidadC = Convert.ToInt32(txtGrandeC.Text);
