<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registro.aspx.cs" Inherits="Proyecto_DSP.Registro" %>
            ...
            <div class="col">
                <form id="formulario_registro" class="form-check" runat="server">
                    <div>
                        ...
                        <br />
                        <div>
                            <asp:Button ID="BtnRegistrar" Text="Registrar" CssClass="btn btn-dark btn-primary"  runat="server" />
                            <asp:Button ID="BtnVolver" Text="Volver" CssClass="btn btn-dark btn-primary" OnClick="BtnVolver_Click" runat="server" />
                        </div>
                    </div>
                </form>
            </div>
